...
/**
 * This file contains the IfProcessorTestCase class.
 *
...
use Pipeline\Processors\IfProcessor;
use Psr\Log\LoggerInterface;

/**
 * This class contains common setup routines, providers
 * and shared attributes for testing the IfProcessor class.
 *
 * @covers Pipeline\Processors\IfProcessor
 */
abstract class IfProcessorTestCase extends MockeryTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->class = new IfProcessor($this->logger);
